System.register([], (function (exports, module) {
    ...
    return {
        execute: (function () {
            ...
            exports('importShared', importShared);

            const scriptRel = 'modulepreload';const assetsURL = function(dep) { return "/"+dep };const seen = {};const __vitePreload = exports('__vitePreload', function preload(baseModule, deps, importerUrl) {
            ...
            const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-57311581.js', module.meta.url).href),import:true},'pinia':{get:()=>()=>__federation_import(new URL('__federation_shared_pinia-89a4b986.js', module.meta.url).href),import:true}};
