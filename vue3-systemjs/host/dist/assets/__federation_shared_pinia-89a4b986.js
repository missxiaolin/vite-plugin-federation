System.register(['./_virtual___federation_fn_import-a03e6aba.js', './runtime-core.esm-bundler-cefba831.js'], (function (exports, module) {
  'use strict';
  var importShared, hasInjectionContext, inject, effectScope, ref, markRaw, toRaw, isRef, isReactive, toRef, watch, reactive, getCurrentScope, onScopeDispose, nextTick, toRefs, computed;
  return {
    setters: [module => {
    ...
    execute: (async function () {
      ...
      const setActivePinia = exports('setActivePinia', (pinia) => (activePinia = pinia));
      /**
       * Get the currently active pinia if there is any.
       */
      const getActivePinia = exports('getActivePinia', () => (hasInjectionContext() && inject(piniaSymbol)) || activePinia);
       ...
       */
      const mapGetters = exports('mapGetters', mapState);
      /**
       ...
       */
      const PiniaVuePlugin = exports('PiniaVuePlugin', function (_Vue) {
          // Equivalent of
          // app.config.globalProperties.$pinia = pinia
          _Vue.mixin({
              beforeCreate() {
