...
const moduleMap = {'vue':{get:()=>()=>__federation_import(new URL('__federation_shared_vue-599f5207.js', import.meta.url).href),import:true}};
...
const powderblue = "_powderblue_2hygx_2";
const button = "_button_2hygx_6";
const style0 = {
...
const {toDisplayString:_toDisplayString,normalizeClass:_normalizeClass,createElementVNode:_createElementVNode$1,openBlock:_openBlock$1,createElementBlock:_createElementBlock$1} = await importShared('vue');


const _hoisted_1 = { id: "css-modules-div" };

function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return (_openBlock$1(), _createElementBlock$1("div", _hoisted_1, [
    _createElementVNode$1("h1", {
      class: _normalizeClass(_ctx.$style.powderblue)
    }, _toDisplayString(_ctx.title) + "ceshi", 3),
    _createElementVNode$1("button", {
      class: _normalizeClass(_ctx.$style.button),
      onClick: _cache[0] || (_cache[0] = $event => (_ctx.title = _ctx.title + '!'))
    }, "Button with styleceshi", 2)
  ]))
}
const cssModules = {
"$style":style0,
};
const Button = /*#__PURE__*/_export_sfc(_sfc_main$1, [['render',_sfc_render$1],['__cssModules',cssModules]]);
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (_openBlock(), _createElementBlock("div", null, [
    _cache[0] || (_cache[0] = _createElementVNode("h3", null, "css-modules Remote App", -1)),
