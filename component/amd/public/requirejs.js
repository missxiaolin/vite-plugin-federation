...
!(function (global) {
  ...
  function makeContextModuleFunc(e, t, i) {
    return function () {
      var r,
        n = aps.call(arguments, 0);
      return (
        i && isFunction((r = n[n.length - 1])) && (r.__requireJsBuild = !0),
        n.push(t),
        e.apply(null, n)
      );
    };
  ...
  function newContext(e) {
    ...
    function i(e, i, r) {
      ...
      if (
        (e &&
          "." === e.charAt(0) &&
          (i
            ? ((f = M.pkgs[i] ? [i] : f.slice(0, f.length - 1)),
              (e = f.concat(e.split("/"))),
              t(e),
              (o = M.pkgs[(n = e[0])]),
              (e = e.join("/")),
        ...
        for (s = e.split("/"), u = s.length; u > 0; u -= 1) {
          if (((d = s.slice(0, u).join("/")), f))
            for (c = f.length; c > 0; c -= 1)
              if ((a = l[f.slice(0, c).join("/")]) && (a = a[d])) {
                p = a;
                break;
              }
          if ((!p && h && h[d] && (p = h[d]), p)) {
    ...
    function n(e) {
      ...
      return t && isArray(t) && t.length > 1
        ? (r(e), t.shift(), E.undef(e), E.require([e]), !0)
        : void 0;
    }
    function o(e, t, r, n) {
      var o,
      ...
      return (
        e || ((l = !1), (e = "_@r" + (D += 1))),
        -1 !== c &&
          ((d = e.substring(0, c)), (e = e.substring(c + 1, e.length))),
        d && (d = i(d, p, n)),
        e &&
          (d
            ? ((s = A[d]),
              (o =
                s && s.normalize
                  ...
                  : i(e, p, n)))
            : ((o = i(e, p, n)),
              (a = C[o]) || ((a = E.nameToUrl(e, null, t)), (C[o] = a)))),
        (u = !d || s || r ? "" : "_unnormalized" + (R += 1)),
        {
          prefix: d,
          name: o,
          parentMap: t,
    ...
    function s(e, t, i) {
      var r = e.id,
        n = k[r];
      !hasProp(A, r) || (n && !n.defineEmitComplete)
        ? a(e).on(t, i)
        : "defined" === t && i(A[r]);
    }
    function u(e, t) {
    ...
    function c() {
      globalDefQueue.length &&
        (apsp.apply(j, [j.length - 1, 0].concat(globalDefQueue)),
        (globalDefQueue = []));
    }
    function d(e, t, i) {
      var r = e && e.map,
        n = makeContextModuleFunc(i || E.require, r, t);
    ...
    function p(e) {
      delete k[e],
        each(T, function (t, i) {
          return t.map.id === e
            ? (T.splice(i, 1), t.defined || (E.waitCount -= 1), !0)
            : void 0;
        });
    }
    function f(e, t) {
    ...
    function m() {
      var e,
        ...
        o,
        a = 1e3 * M.waitSeconds,
        s = a && E.startTime + a < new Date().getTime(),
        c = [],
        d = !1,
        p = !0;
      if (!b) {
        if (
          ...
          eachProp(k, function (i) {
            if (((e = i.map), (t = e.id), i.enabled && !i.error))
              if (!i.inited && s)
                n(t) ? ((o = !0), (d = !0)) : (c.push(t), r(t));
              else if (
                !i.inited &&
                i.fetched &&
                e.isDefine &&
          ...
          return (
            (i = makeError(
              "timeout",
              "Load timeout for modules: " + c,
              null,
              c
            )),
            (i.contextName = E.contextName),
            u(i)
          );
        p &&
          (each(T, function (e) {
    ...
    function x(e) {
      ...
      return (
        v(t, E.onScriptLoad, "load", "onreadystatechange"),
        v(t, E.onScriptError, "error"),
    ...
    var b,
      ...
      y,
      S,
      M = { waitSeconds: 7, baseUrl: "./", paths: {}, pkgs: {}, shim: {} },
      k = {},
      w = {},
      j = [],
      A = {},
    ...
    return (
      (y = {
        ...
        exports: function (e) {
          return (
            (e.usingExports = !0),
            e.map.isDefine ? (e.exports = A[e.map.id] = {}) : void 0
          );
        },
        module: function (e) {
          return (e.module = {
      ...
      (q.prototype = {
        ...
        defineDepById: function (e, t) {
          var i;
          return (
            each(this.depMaps, function (t, r) {
                ...
                if (
                  ...
                  if (isFunction(a)) {
                    ...
                    if (
                      (this.map.isDefine &&
                        ((i = this.module),
                        i && void 0 !== i.exports && i.exports !== this.exports
                          ? (o = i.exports)
                          : void 0 === o &&
                            this.usingExports &&
                            (o = this.exports)),
                  ...
                  (this.exports = o),
                    this.map.isDefine &&
                      ...
                      ((A[r] = o),
                      req.onResourceLoad &&
                        req.onResourceLoad(E, this.map, this.depMaps)),
                    delete k[r],
                    (this.defined = !0),
                    (E.waitCount -= 1),
                    0 === E.waitCount && (T = []);
        ...
        enable: function () {
          (this.enabled = !0),
            this.waitPushed ||
              (T.push(this), (E.waitCount += 1), (this.waitPushed = !0)),
            each(
              this.depMaps,
              bind(this, function (e) {
                var t = e.id,
      ...
      (E = {
        ...
        configure: function (e) {
          ...
          mixin(M, e, !0),
            mixin(t, e.paths, !0),
            (M.paths = t),
            e.map && (mixin(n, e.map, !0), (M.map = n)),
            e.shim &&
              (eachProp(e.shim, function (e, t) {
                isArray(e) && (e = { deps: e }),
                  e.exports &&
                    !e.exports.__buildReady &&
                    (e.exports = E.makeShimExports(e.exports)),
                  (r[t] = e);
              }),
              (M.shim = r)),
            e.packages &&
        ...
        require: function (t, i, r, n) {
          ...
          if ("string" == typeof t)
            return isFunction(i)
              ? u(makeError("requireargs", "Invalid require call"), r)
              : req.get
              ? req.get(E, t, i)
              : ((s = t),
                (n = i),
          ...
          for (
            r && !isFunction(r) && ((n = r), (r = void 0)),
              i && !isFunction(i) && ((n = i), (i = void 0)),
              c();
            j.length;

          ) {
            if (((l = j.shift()), null === l[0]))
              return u(
                makeError(
                  "mismatch",
                  "Mismatched anonymous define() module: " + l[l.length - 1]
                )
              );
            g(l);
          }
        ...
        undef: function (e) {
          ...
          delete A[e],
            ...
            delete P[t.url],
            delete w[e],
            i && (i.events.defined && (w[e] = i.events), p(e));
        },
        enable: function (e) {
          k[e.id] && a(e).enable();
        },
        ...
        nameToUrl: function (e, t, r) {
          ...
          if (((e = i(e, r && r.id, !0)), req.jsExtRegExp.test(e)))
            p = e + (t || "");
          else {
            for (
              n = M.paths, o = M.pkgs, u = e.split("/"), c = u.length;
              c > 0;
              c -= 1
            ) {
              ...
              if (a) {
                (s = e === a.name ? a.location + "/" + a.main : a.location),
                  u.splice(0, c, s);
                break;
              }
            }
        ...
        onScriptError: function (e) {
          ...
          return n(t.id)
            ? void 0
            : u(makeError("scripterror", "Script error", e, [t.id]));
        },
      })
    );
  }
      ...
      (req.load = function (e, t, i) {
        ...
        return isBrowser
          ? ((r = n.xhtml
            ...
            r)
          : void (isWebWorker && (importScripts(i), e.completeLoad(t)));
      }),
      isBrowser &&
        eachReverse(scripts(), function (e) {
          return (
